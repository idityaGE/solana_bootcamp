...
export type DecrementInput<TAccountTokenlottery extends string = string> = {
...
>(
  input: DecrementInput<TAccountTokenlottery>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountTokenlottery> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as DecrementInstruction<TProgramAddress, TAccountTokenlottery>);
}
