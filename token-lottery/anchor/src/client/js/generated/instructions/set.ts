...
export type SetInput<TAccountTokenlottery extends string = string> = {
...
>(
  input: SetInput<TAccountTokenlottery>,
  config?: { programAddress?: TProgramAddress }
): SetInstruction<TProgramAddress, TAccountTokenlottery> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as SetInstruction<TProgramAddress, TAccountTokenlottery>);
}
